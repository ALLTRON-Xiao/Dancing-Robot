...
class G1RoughCfg( LeggedRobotCfg ):
    class init_state( LeggedRobotCfg.init_state ):
        pos = [0.0, 0.0, 0.8] # x,y,z [m] 0 0 0.6 for wota
        # pos = [0.0, 0.0, 0.8] # x,y,z [m] 0 0 0.6 for wota
        default_joint_angles = { # stand
        ...
        # default_joint_angles = { # = target angles [rad] when action = 0.0 #wota
        #     'left_hip_pitch_joint': 0.0,
        #     'left_hip_roll_joint': 1.3,
        #     'left_hip_yaw_joint': 1.32,
        #     'left_knee_joint': 1.14,
        #     'left_ankle_pitch_joint': 0.0,
        #     'left_ankle_roll_joint': 0.0,
        #     'right_hip_pitch_joint': 0.0,
        #     'right_hip_roll_joint': -1.31,
        #     'right_hip_yaw_joint': -1.32,
        #     'right_knee_joint': 1.14,
        ...
        # default_joint_angles = { # = target angles [rad] when action = 0.0 #sigle leg
        #     'left_hip_pitch_joint': 0.0,
        #     'left_hip_roll_joint': 1.4,
        #     'left_hip_yaw_joint': 0.0,
        #     'left_knee_joint': 0.0,
        ...
        #     'right_ankle_roll_joint': 0.0,
        #     'waist_yaw_joint': 0.0,
        #     'left_shoulder_pitch_joint': -0.238,
        #     'left_shoulder_roll_joint':1.77,
        #     'left_shoulder_yaw_joint': 2.62,
        #     'left_elbow_joint': 1.89,
        #     'left_wrist_roll_joint': -1.97,
        #     'right_shoulder_pitch_joint': -0.353,
        #     'right_shoulder_roll_joint': -1.7,
        #     'right_shoulder_yaw_joint': -2.62,
        #     'right_elbow_joint': 2.03,
        #     'right_wrist_roll_joint': 1.76,  
        #     'torso_joint' : 0.0
        # }
